...
/datum/id_trim/job/Internal_affairs_officer
	assignment = "internal affairs officer"
	trim_icon = 'modular_skyrat/master_files/icons/obj/card.dmi'
	trim_state = "trim_Internal_affairs_officer"
	department_color = COLOR_ASSEMBLY_BLACK
	subdepartment_color = COLOR_ASSEMBLY_BLACK
	sechud_icon_state = SECHUD_Internal_affairs_officer
	extra_access = list()
	minimal_access = list(
	...
	job = /datum/job/Internal_affairs_officer
