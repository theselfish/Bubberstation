...
#define JOB_Internal_affairs_officer "internal affairs officer" // SKYRAT EDIT ADDITION
//Engineering
...
#define JOB_DISPLAY_ORDER_Internal_affairs_officer 39 //SKYRAT EDIT ADDITON
